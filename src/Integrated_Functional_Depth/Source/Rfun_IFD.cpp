...
extern "C" {
    ...
    /*!
    	...
    	\param Rwfunction the weight function (represented as an R-vector).
    ...
    */
    ...
    SEXP Integrated_Functional_Depth(SEXP Rdata, SEXP Rmesh, SEXP Rorder, SEXP Rmydim, SEXP Rndim, SEXP Rweights, SEXP Rwfunction, SEXP Rsearch, SEXP Rdepth)
    {
	...
	if(order== 1 && mydim==2 && ndim==2)
		return(IFD_Skeleton<1, 2, 2>(Rdata, Rorder, Rweights, Rwfunction, Rsearch, Rmesh, depth_choice));
	else if(order== 2 && mydim==2 && ndim==2)
		return(IFD_Skeleton<2, 2, 2>(Rdata, Rorder, Rweights, Rwfunction, Rsearch, Rmesh, depth_choice));
	else if(order== 1 && mydim==2 && ndim==3)
		return(IFD_Skeleton<1, 2, 3>(Rdata, Rorder, Rweights, Rwfunction, Rsearch, Rmesh, depth_choice));
	else if(order== 2 && mydim==2 && ndim==3)
		return(IFD_Skeleton<2, 2, 3>(Rdata, Rorder, Rweights, Rwfunction, Rsearch, Rmesh, depth_choice));
	else if(order == 1 && mydim==3 && ndim==3)
		return(IFD_Skeleton<1, 3, 3>(Rdata, Rorder, Rweights, Rwfunction, Rsearch, Rmesh, depth_choice));
	else if(order == 2 && mydim==3 && ndim==3)
		return(IFD_Skeleton<2, 3, 3>(Rdata, Rorder, Rweights, Rwfunction, Rsearch, Rmesh, depth_choice));
