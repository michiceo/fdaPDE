...
public:
	...
	DataProblem(SEXP Rdata, SEXP Rorder, SEXP Rweights, SEXP Rsearch, SEXP Rmesh, const std::string& d, SEXP RnThreads);
	...
	inline UInt getNThreads() const {return ifdData_.getNThreads();}
